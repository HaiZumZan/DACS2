...
<body>
          ...
          <!-- Owl-carousel -->
            <section id="banner-area">
              <div class="owl-carousel owl-theme">
                  ...
                  <div class="item">
                    <img src="./assets/BannerIPHONE.png" alt="Banner3">
                  </div>
              </div>
            </section>
          <!-- !Owl-carousel -->
          ...
          <section id="top-sale">
            <div class="container py-5">
              ...
              <!-- owl carousel -->
                <div class="owl-carousel owl-theme">
                  <div class="item py-2">
                    <div class="product font-rale" data-image="./assets/products/1.png" data-name="Samsung Galaxy S6">
                  ...
                  <div class="item py-2">
                    <div class="product font-rale" data-image="./assets/products/2.png" data-name="Xiaomi Redmi 3">
                      <a href="#"><img src="./assets/products/2.png" alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>Xiaomi Redmi 3</h6>
                        <div class="rating text-warning font-size-12">
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                  ...
                  <div class="item py-2">
                    <div class="product font-rale" data-image="./assets/products/3.png" data-name="Xiaomi Redmi 6">
                      <a href="#"><img src="../assets/products/3.png" alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>Xiaomi Redmi 6</h6>
                        <div class="rating text-warning font-size-12">
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                  ...
                  <div class="item py-2">
                    <div class="product font-rale" data-image="./assets/products/6.png" data-name="Xiaomi Redmi Note 5">
                      <a href="#"><img src="../assets/products/6.png" alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>Xiaomi Redmi Note 5</h6>
                        <div class="rating text-warning font-size-12">
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
              ...
              <div class="grid">
                <div class="grid-item Apple border">
                 <div class="item py-2" style="width: 200px;">
                  <div class="product font-rale" data-image="./assets/products/13.png" data-name="Apple Iphone X">
                ...
                <div class="grid-item Samsung border">
                  <div class="item py-2" style="width: 200px;">
                   <div class="product font-rale" data-image="./assets/products/11.png" data-name="Samsung Galaxy S6">
                 ...
                 <div class="grid-item Redmi border">
                  <div class="item py-2" style="width: 200px;">
                   <div class="product font-rale" data-image="./assets/products/3.png" data-name="Redmi 6">
                     <a href="#"><img src="../assets/products/3.png" alt="product1" class="img-fluid"></a>
                     <div class="text-center">
                       <h6>Redmi 6</h6>
                       <div class="rating text-warning font-size-12">
                 ...
                 <div class="grid-item Apple border">
                  <div class="item py-2" style="width: 200px;">
                   <div class="product font-rale" data-image="./assets/products/14.png" data-name="Apple Iphone 4S">
                     <a href="#"><img src="../assets/products/14.png" alt="product1" class="img-fluid"></a>
                     <div class="text-center">
                       <h6>Apple iPhone 4S</h6>
                       <div class="rating text-warning font-size-12">
                         <span><i class="fas fa-star"></i></span>
                         <span><i class="fas fa-star"></i></span>
                         <span><i class="fas fa-star"></i></span>
                 ...
                 <div class="grid-item Samsung border">
                  <div class="item py-2" style="width: 200px;">
                   <div class="product font-rale" data-image="./assets/products/12.png" data-name="Samsung Galaxy S7">
                 ...
                 <div class="grid-item  Redmi border ">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column" data-image="./assets/products/4.png" data-name="Redmi Note 5A">
                ...
                <div class="grid-item  Redmi border ">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale" data-image="./assets/products/5.png" data-name="Redmi Note 5A">
                      <div class="d-flex flex-column">
                ...
                <div class="grid-item  Redmi border ">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column" data-image="./assets/products/6.png" data-name="Redmi Note 7 Pro">
                ...
                <div class="grid-item  Redmi border">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale" data-image="./assets/products/10.png" data-name="Redmi Note 7 Pro">
                      <div class="d-flex flex-column">
                ...
                <div class="grid-item Apple border  " >
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale" data-image="./assets/products/13.png" data-name="Apple iPhone 10" >
                      <div class="d-flex flex-column">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
