...
if (isset($_POST['proceed_to_buy'])) {
    ...
    $product_id = $_POST['product_id']; // Giả sử bạn đã có trường này
    $product_name = $_POST['product_name'];
    $product_price = $_POST['product_price'];
    $quantity = $_POST['quantity'];

    // Kết nối đến cơ sở dữ liệu
    $conn = new mysqli("localhost", "root", "", "thanh_toan");
    ...
    $sql = "INSERT INTO product_detail (product_id, product_name, product_price, quantity) VALUES ('$product_id', '$product_name', '$product_price', '$quantity')";
                                ...
                                <div class="col-sm-3">
                                    <div class="sub-total border text-center mt-2">
                                        ...
                                        <div class="border-top py-4">
                                            ...
                                            <!-- Xử lý thanh toán sản phẩm thêm vào database -->
                                            <form id="cart_form" method="POST" action="cart.php">
                                                <input type="hidden" name="product_id" value="2">
                                                <input type="hidden" name="product_name" value="Samsung Galaxy 10">
                                                <input type="hidden" name="product_price" value="152">
                                                <input type="hidden" name="quantity" value="3">
                                                <button type="submit" name="proceed_to_buy" class="btn btn-warning mt-3">Proceed to Buy</button>
