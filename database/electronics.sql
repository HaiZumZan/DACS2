...
CREATE TABLE `product` (
  ...
  `item_image` varchar(255) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(13, 'Apple','Apple Iphone 16 Pro Max', 699.00, './assets/products/16.png'),
(14, 'Apple', 'Apple iPhone 7', 152.00, './assets/products/15.png');
